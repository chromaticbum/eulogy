...
mysql_console: compile
	erl -pa ebin -pa ../eu_mysql_adapter/ebin -eval "application:start(crypto), application:start(emysql), application:start(eulogy), application:start(eu_mysql_adapter)."
